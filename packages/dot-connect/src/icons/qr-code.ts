...
export function qrCode({ size = 24 }: IconProps) {
  ...
  >
    ...
    <path d="M9.67999 26.375L1.99999 26.375L1.99999 17.735" fill="none" data-nofill="true"></path>
    <path d="M26 18.695L26 26.375L18.32 26.375" fill="none" data-nofill="true"></path>
    <path d="M2 10.055L2 2.37496L9.68 2.37496" fill="none" data-nofill="true"></path>
